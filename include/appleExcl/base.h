...
#ifndef __ASSUME_PTR_ABI_SINGLE_END
...
// Conditionally include baseObjC.h or a fallback based on compilation mode

#ifndef __has_feature
#define __has_feature(x) 0
#endif

#if __has_feature(objc) || defined(__OBJC__) || defined(__BLOCKS__)
  #include "Obj-C/baseObjC.h"
#else
  #include "os_block_types.h"
#endif
...
// These macros apply regardless of language
